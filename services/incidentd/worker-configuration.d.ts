/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a890e9914fda0db5d331722b4256f597)
// Runtime types generated with workerd@1.20260305.0 2025-12-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Incident" | "SimilarIncidentsAgent" | "GitHubCommitsAgent";
	}
	interface Env {
		INCIDENT_ARCHIVE: R2Bucket;
		incidents: D1Database;
		db: Hyperdrive;
		FRONTEND_URL: "https://app.firedash.ai";
		...
		SIMILAR_INCIDENTS_AGENT: DurableObjectNamespace<import("./src/index").SimilarIncidentsAgent>;
		GITHUB_COMMITS_AGENT: DurableObjectNamespace<import("./src/index").GitHubCommitsAgent>;
