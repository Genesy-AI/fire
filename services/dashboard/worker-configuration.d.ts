/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 131b4138ae234c8ee85634b98664d711)
// Runtime types generated with workerd@1.20260521.1 2025-12-19 nodejs_compat
interface __BaseEnv_Env {
	...
	INCIDENTD: Fetcher /* incidentd */;
	ROTATION_WORKFLOW: Workflow<Parameters<import("./src/server").RotationScheduleWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLIENT_ID" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "VITE_APP_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SLACK_CLIENT_ID" | "SLACK_CLIENT_SECRET">> {}
}
